...
$oturum = curl_init("http://localhost/php-dersleri/php_Udmey/curlSistem/curl-sistem/islemler.php?islem=kayıtsil&uyeid=" . $uyeid); // sadece deneme icin bir olacalde calıştırıyorum.
