...
<body id="page-top">
  ...
  <div class="row">
  <div class="col-lg-12"><h1 class="mt-5 text-center">CURL İÇİN TEST İŞLEMLERİ YAN MENÜDE</h1></div>
	...
	<div class="row text-dark mt-5 ">	
							<div class="col-lg-3  bg-light mx-auto border border-dark table-borderless">
								<div class="row">
							<div class="col-lg-12"><h4>KİŞİ EKLE</h4></div>
									
										<div class="col-lg-6 p-2 mt-2 ">Ad</div>
										<div class="col-lg-6 p-2"><form action="http://websitekurma.xyz/curltest/islemler.php?islem=kayitekle" method="post">
									...
									<div class="col-lg-12 p-2 mt-2"><input type="submit" name="gonder" value="EKLE" class="btn btn-success"></form></div>
	...
	<div class="row text-dark mt-5 ">	
							<div class="col-lg-3  bg-light mx-auto border border-dark table-borderless">
								<div class="row">
							<div class="col-lg-12"><h4>KİŞİ GÜNCELLE</h4></div>
									
										<div class="col-lg-6 p-2 mt-2 ">Ad</div>
										<div class="col-lg-6 p-2"><form action="http://websitekurma.xyz/curltest/islemler.php?islem=kayitguncelle" method="post">
											<input type="text" name="ad" class="form-control" value="<?php echo $uyeninBilgileri["ad"]; ?>"></div>
										<div class="col-lg-6 p-2 mt-2">Soyad</div>
								...
								<input type="hidden" name="uyeid" value="<?php echo $uyeninBilgileri["id"]; ?>" ></form></div>
	...
	<div class="col-lg-5 bg-danger bg-light mx-auto border border-dark">
        		<div class="row">		
        			<div class="col-lg-12"><h4> <a href="http://websitekurma.xyz/curltest/index.php?hareket=ekle" class="btn btn-primary btn-sm">Ekle</a> ÜYELER</h4></div>
					...
					<a href="http://websitekurma.xyz/curltest/index.php?hareket=guncelle&uyeid='.$sonucum["id"].'" class="btn btn-success btn-sm">Güncelle</a>
					<a href="http://websitekurma.xyz/curltest/islemler.php?islem=kayitsil&uyeid='.$sonucum["id"].'" class="btn btn-danger btn-sm">Sil</a></div>';
					endwhile;
