    ...
    <div class="container">
        <div class="row">
            <div class="col-md-9">
                ...
                <div class="f-credit">&copy;<?php echo $ayarcek['ayar_author'] ?> <a href="http://www.startsupply.com">www.startsupplay</a></div>
                <a href="">
            ...
            <div class="col-md-3"><!--footer Share-->
                ...
                <div class="fsoc">
                    <a href="http://<?php echo $ayarcek['ayar_tiwitter'] ?>" class="ftwitter">twitter</a>
                    <a href="http://<?php echo $ayarcek['ayar_facebook'] ?>" class="ffacebook">facebook</a>
                    <a href="http://<?php echo $ayarcek['ayar_github'] ?>" class="fflickr">github</a>
